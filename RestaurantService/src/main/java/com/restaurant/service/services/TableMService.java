...
public class TableMService {
	...
	public List<TableM> listTableByPerson(String person_number, String date, String time) {
		return (List<TableM>) tableRepository.listTableByPerson(person_number, date, time);
	}
