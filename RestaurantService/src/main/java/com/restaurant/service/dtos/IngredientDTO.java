...
public class IngredientDTO {
	...
	public IngredientDTO(Long id, String ingredientName, String ingredientCode, String categoryName,
			BigDecimal quantityInStock, BigDecimal price, String photo, IngredientStatus status) {
		super();
		this.id = id;
		this.ingredientName = ingredientName;
		this.ingredientCode = ingredientCode;
	...
	public IngredientDTO(Long id, String ingredientName, BigDecimal weight, String description, String ingredientCode,
			String categoryName, Long categoryId, BigDecimal quantityInStock, BigDecimal price, String photo,
			boolean halfPortionAvailable, IngredientStatus status) {
		super();
		this.id = id;
		this.ingredientName = ingredientName;
		this.weight = weight;
	...
	public static IngredientDTO fromEntity(Ingredient ing) {
		return new IngredientDTO(ing.getId(), ing.getIngredientName(), ing.getWeight(), ing.getDescription(),
				ing.getIngredientCode(), ing.getCategory().getCategoryName(), ing.getCategory().getId(),
				ing.getQuantityInStock(), ing.getPrice(), ing.getPhoto(), ing.isHalfPortionAvailable(),ing.getStatus());
	}
	...
	public IngredientDTO(Long id, String ingredientName, BigDecimal weight, String description,
			...
			Long categoryId, BigDecimal quantityInStock, BigDecimal price, String photo) {
		super();
		this.id = id;
		this.ingredientName = ingredientName;
		this.weight = weight;
