package com.restaurant.service.paging;
...
public class PagingAndSortingArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer model, NativeWebRequest request,
		...
		System.out.println("PagingAndSortingArgumentResolver::" + " sortField: " + sortField + " sortDir: " + sortDir);

		if (sortDir == null) { sortDir = "asc"; }
		if (sortField == null) { sortField = annotation.defaultSortField(); }
		...
		return new PagingAndSortingHelper(model, annotation.listName(), sortField, sortDir, searchText);
	}
