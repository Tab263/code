...
public class CustomerServiceTest {
	...
	public void testCreaateCustomerWithShipAddress() {
		...
		ShipAddress shipAddress = new ShipAddress("Customer Ship", "0987665332", "123 ABC");
		shipAddress.setShipDefault(true);
		
		Customer savedCustomer = customerService.createCustomer(customer, shipAddress);
